...
export const DEFAULT_FLAGS = [
  ...
  { key: 'ofertas', enabled: true, description: 'Activa la pagina y gestion de ofertas.' },
  {
    key: 'newsletter',
    enabled: false,
    description: 'Activa suscripcion y campanas de newsletter.',
  },
...
export const DEFAULT_SETTINGS: Array<{ key: string; value: string; locale: 'ES' | 'CA' }> = [
  ...
  },
  {
    ...
    locale: 'ES',
    value:
      'Recibe ideas practicas sobre ahorro, precio de la luz, domotica y recomendaciones seleccionadas.',
  },
  {
  ...
  },
  {
    ...
    locale: 'ES',
    value:
      'Transformamos la manera en que hogares y empresas consumen energia. Analisis tecnicos, domotica avanzada y eficiencia energetica real.',
  },
  {
    key: 'newsletter.title',
    locale: 'CA',
  ...
  },
  {
    ...
    locale: 'CA',
    value:
      'Rep idees practiques sobre estalvi, preu de la llum, domotica i recomanacions seleccionades.',
  },
  {
    key: 'newsletter.legal',
    locale: 'CA',
    value:
      'Accepto rebre comunicacions de Webtense Energy i puc donar-me de baixa en qualsevol moment.',
  },
  {
    key: 'footer.description',
    locale: 'CA',
    value:
      'Transformem la manera com llars i empreses consumeixen energia. Analisi tecnica, domotica avancada i eficiencia real.',
  },
];

export function getDefaultSettingValue(key: string, locale: 'ES' | 'CA') {
  return (
    DEFAULT_SETTINGS.find((setting) => setting.key === key && setting.locale === locale)?.value ||
    ''
  );
}
