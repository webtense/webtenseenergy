      ...
      <div className="section-inner max-w-4xl">
        ...
        <div className="surface-panel mt-10 space-y-8 p-8 md:p-10 text-sm leading-7 text-foreground/70">
          <section>
            ...
            <p className="mt-3">
              Las cookies son pequeños archivos que permiten recordar información básica de
              navegación, preferencias o medición del uso del sitio.
            </p>
          </section>
          <section>
            <h2 className="font-heading text-2xl font-bold tracking-tight text-foreground">
            ...
            <p className="mt-3">
              Utilizamos cookies y tecnologías similares para funcionamiento técnico, analítica
              básica, seguridad y mejora de la experiencia cuando proceda.
            </p>
          </section>
          <section>
            <h2 className="font-heading text-2xl font-bold tracking-tight text-foreground">
            ...
            <p className="mt-3">
              ...
              cuenta que algunas funciones del sitio pueden dejar de comportarse correctamente.
            </p>
          </section>
        </div>
      </div>
