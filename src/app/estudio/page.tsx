...
export const metadata = {
  ...
  description: "Sube tu factura de luz o dinos cuánto consumes y obtén un estudio energético personalizado para ahorrar en tu hogar o negocio.",
};
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-zinc-50 dark:bg-zinc-950 p-8 rounded-3xl border border-zinc-200 dark:border-white/5 shadow-sm hover:shadow-md transition-shadow">
              ...
              <p className="text-foreground/70 dark:text-zinc-400 leading-relaxed">Comparamos más de 30 comercializadoras para encontrar la que mejor se adapta a tus hábitos reales de consumo.</p>
            </div>
            ...
            <div className="bg-zinc-50 dark:bg-zinc-950 p-8 rounded-3xl border border-zinc-200 dark:border-white/5 shadow-sm hover:shadow-md transition-shadow">
              ...
              <p className="text-foreground/70 dark:text-zinc-400 leading-relaxed">Nosotros nos encargamos de todo el proceso de cambio de compañía si decides aceptar nuestra recomendación.</p>
            </div>
            ...
            <div className="bg-zinc-50 dark:bg-zinc-950 p-8 rounded-3xl border border-zinc-200 dark:border-white/5 shadow-sm hover:shadow-md transition-shadow">
              ...
              <p className="text-foreground/70 dark:text-zinc-400 leading-relaxed">No trabajamos en exclusiva para ninguna distribuidora. Nuestro único objetivo es que tú pagues menos a fin de mes.</p>
            </div>
          </div>
        </div>
      </section>
