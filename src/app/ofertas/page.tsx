    ...
    <div className="flex flex-col bg-background min-h-screen">
      ...
      <section className="relative pt-32 pb-20 overflow-hidden border-b border-zinc-200 dark:border-white/5 bg-zinc-50 dark:bg-transparent">
        ...
        <div className="container relative z-10 mx-auto px-4 text-center mt-10">
          ...
          <a href="https://t.me/webtenseenergy" target="_blank" rel="noopener noreferrer" className="inline-flex relative group overflow-hidden rounded-full font-bold text-white transition-all shadow-[0_0_30px_rgba(42,171,238,0.3)] bg-[#2AABEE] px-8 py-4">
      ...
      <section className="container mx-auto px-4 py-16 pb-32 relative z-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {ofertas.map((oferta, index) => (
            <div key={index} className="group flex flex-col bg-white dark:bg-[#0a0f1c] border border-zinc-200 dark:border-white/5 hover:border-brand-500/50 rounded-3xl overflow-hidden transition-all duration-300 hover:-translate-y-2 hover:shadow-xl dark:hover:shadow-[0_10px_40px_rgba(59,130,246,0.15)] relative">
              ...
              <div className="p-6 flex flex-col flex-1 border-t border-zinc-100 dark:border-white/5 bg-gradient-to-b from-transparent to-zinc-50 dark:to-[#050810]">
                ...
                <div className="mt-auto flex items-end justify-between">
                  ...
                  <button className="w-10 h-10 rounded-full bg-brand-600 text-white flex items-center justify-center group-hover:bg-brand-500 transition-colors shadow-md dark:shadow-lg">
