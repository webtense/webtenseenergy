    ...
    <div className="flex flex-col bg-background">
      ...
      <section className="relative pt-32 pb-20 lg:pt-40 lg:pb-32 overflow-hidden bg-zinc-50 dark:bg-transparent border-b border-zinc-200 dark:border-white/5">
        ...
        <div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8 text-center mt-10">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
            <Link href="/contacto" className="relative group overflow-hidden rounded-full px-10 py-5 font-bold text-white transition-all shadow-[0_0_30px_rgba(26,183,117,0.3)] bg-primary-600 dark:bg-primary-500 w-full sm:w-auto">
            ...
            <Link href="#servicios" className="group rounded-full border border-zinc-200 dark:border-white/10 bg-white dark:bg-white/5 shadow-sm backdrop-blur-sm px-10 py-5 font-bold text-foreground hover:bg-zinc-50 dark:hover:bg-white/10 hover:border-zinc-300 dark:hover:border-white/20 transition-all w-full sm:w-auto">
              Descubrir Servicios
            </Link>
          </div>
        </div>
        ...
        <div className="bg-white/80 dark:bg-white/5 backdrop-blur-2xl border border-zinc-200 dark:border-white/10 rounded-3xl p-8 shadow-xl dark:shadow-[0_8px_30px_rgb(0,0,0,0.5)]">
          <div className="flex flex-col md:flex-row justify-around items-center gap-12 text-center md:divide-x md:divide-zinc-200 md:dark:divide-white/10">
            <div className="w-full">
              <div className="text-5xl font-extrabold text-foreground mb-2 tracking-tighter shadow-sm"><span className="text-primary-600 dark:text-primary-400">12-18</span>%</div>
              <div className="text-sm font-bold text-foreground/60 dark:text-zinc-500 uppercase tracking-widest mt-3">Ahorro Promedio</div>
            </div>
            <div className="w-full">
              <div className="text-5xl font-extrabold text-foreground mb-2 tracking-tighter"><span className="text-brand-600 dark:text-brand-400">+50</span>M</div>
              <div className="text-sm font-bold text-foreground/60 dark:text-zinc-500 uppercase tracking-widest mt-3">kWh Gestionados</div>
            </div>
            <div className="w-full">
              <div className="text-5xl font-extrabold text-foreground mb-2 tracking-tighter"><span className="text-emerald-600 dark:text-emerald-400">100</span>%</div>
      ...
      <section id="servicios" className="py-24 relative">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-20">
            ...
            <p className="text-foreground/70 dark:text-zinc-400 max-w-2xl mx-auto text-lg">Soluciones integrales diseñadas estratégicamente para la optimización y transición energética de las empresas más exigentes.</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {servicios.map((s, i) => (
              <div key={i} className="group relative bg-white dark:bg-[#0a0f1c] border border-zinc-200 dark:border-white/5 rounded-3xl p-10 shadow-sm hover:shadow-xl dark:shadow-none hover:-translate-y-2 transition-all duration-300 overflow-hidden">
                ...
                <h3 className="text-2xl font-bold font-heading mb-4 text-foreground group-hover:text-primary-600 dark:group-hover:text-primary-300 transition-colors">{s.title}</h3>
      ...
      <section className="relative overflow-hidden py-32 mt-10">
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          <h2 className="font-heading text-4xl md:text-6xl font-extrabold text-white mb-8 tracking-tight">
            Deja de pagar de más por tu energía
          </h2>
          ...
          <Link href="/estudio" className="inline-block bg-white text-primary-950 font-bold px-12 py-5 rounded-full hover:scale-105 hover:shadow-[0_0_40px_rgba(255,255,255,0.4)] transition-all text-lg">
