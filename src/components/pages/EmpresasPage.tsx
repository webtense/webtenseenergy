...
export function EmpresasPage({ basePath }: EmpresasPageProps) {
  ...
  const services = [
    {
      ...
      desc: 'Revisamos estructura, potencias, periodos y condiciones para alinear compra y consumo.',
      icon: '📑',
    },
    {
      title: 'Gestión energética',
      desc: 'Seguimiento periódico del gasto y los desvíos para detectar fugas de margen con rapidez.',
      icon: '📊',
    },
    {
      title: 'Auditoría técnica',
      desc: 'Analizamos suministro, incidencias, calidad, reactiva y oportunidades de mejora operativa.',
      icon: '⚡',
    },
    {
      title: 'Renovables y viabilidad',
      desc: 'Estudios de autoconsumo y electrificación con foco en retorno y estabilidad futura.',
      icon: '☀️',
    },
  ];
  ...
  const process = [
    {
      title: '1. Diagnóstico',
      desc: 'Partimos de facturas, curvas y contexto operativo para ver dónde está el margen real.',
    },
    {
      title: '2. Propuesta',
      desc: 'Traducimos el análisis en medidas concretas, priorizadas y fáciles de decidir.',
    },
    {
      title: '3. Implantación',
      desc: 'Acompañamos cambios de tarifa, ajustes técnicos o despliegues que tengan sentido.',
    },
    {
      title: '4. Seguimiento',
      desc: 'Revisamos resultados para que el ahorro no dependa de una única decisión aislada.',
    },
  ];
  ...
  return (
    <div className="flex flex-col bg-background">
      <SectionHero
        ...
        title={
          <>
            Energía bajo control para{' '}
            <span className="text-primary-600 dark:text-primary-300">
              operaciones que no pueden improvisar
            </span>
          </>
        }
        ...
        actions={
          <>
            ...
            <Link href={withBasePath(basePath, '/estudio')} className="cta-secondary">
              Subir facturas
            </Link>
          </>
        }
      ...
      <section className="section-shell-muted">
        <div className="section-inner">
          <SectionIntro
            eyebrow="Servicios"
            title="Una capa de análisis, decisión y seguimiento"
            description="No vendemos solo un informe. Diseñamos una forma de gestionar mejor la energía y de defender margen con menos incertidumbre."
          />
          <div className="mt-12 grid gap-6 md:grid-cols-2">
            {services.map((service) => (
              <div
                key={service.title}
                className="surface-panel-soft p-7 transition hover:-translate-y-1 hover:border-primary-300 dark:hover:border-primary-500/20"
              >
        ...
        <div className="section-inner grid gap-8 lg:grid-cols-[0.85fr_1.15fr]">
          <div>
            <SectionIntro
              ...
              description="La secuencia importa: no se trata de aplicar medidas aleatorias, sino de intervenir donde el impacto es mayor y la fricción menor."
            />
          </div>
