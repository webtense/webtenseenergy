...
export async function HomePage({ locale, basePath }: HomePageProps) {
  ...
  return (
    <div className="flex flex-col">
      {/* Hero Section */}
      <section className="relative h-[52vh] min-h-[360px] w-full overflow-hidden sm:min-h-[420px]">
        <Image
          ...
          {[
            {
              ...
              link: withBasePath(basePath, "/empresas"),
            ...
            },
            {
              ...
              link: withBasePath(basePath, "/particulares"),
            ...
            },
            {
              ...
              link: withBasePath(basePath, "/blog"),
            ...
            >
              ...
              <p className="text-foreground/70 dark:text-foreground/60 leading-relaxed">{cat.desc}</p>
