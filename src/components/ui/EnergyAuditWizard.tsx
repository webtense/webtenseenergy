      ...
      <div className="p-8 sm:p-10">
        ...
        {step === 1 && (
          <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <p className="text-foreground/70 dark:text-zinc-400 mb-8">
              Para ofrecerte la mejor tarifa, necesitamos conocer tu consumo. Puedes subir una factura reciente o decirnos tu consumo aproximado.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-sm text-foreground/60 dark:text-zinc-500">La opción más precisa. Analizaremos todos tus datos al instante (PDF o Imagen).</p>
                </div>
              </button>
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-sm text-foreground/60 dark:text-zinc-500">¿No tienes la factura a mano? Dinos cuántos kW/h consumes al mes.</p>
                </div>
              </button>
            </div>
          </div>
        ...
        {step === 2 && (
          <div className="animate-in fade-in slide-in-from-right-4 duration-500">
            {formData.method === "upload" ? (
              <>
                ...
                <p className="text-foreground/70 dark:text-zinc-400 mb-6">
                  Puede ser un archivo PDF, JPG o PNG. Tus datos están seguros y solo los usaremos para analizar tu caso.
                </p>

                <div 
                  className={`border-2 border-dashed rounded-2xl p-8 text-center transition-colors cursor-pointer ${
                    dragActive ? "border-primary-500 bg-primary-500/10" : "border-zinc-300 dark:border-zinc-700 hover:border-zinc-500 hover:bg-zinc-800/50"
                  ...
                  {formData.file ? (
                    <div className="flex flex-col items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-foreground/60 dark:text-zinc-500 text-sm">{(formData.file.size / 1024 / 1024).toFixed(2)} MB</p>
                      </div>
                      <button 
                    ...
                    <div className="flex flex-col items-center gap-3">
                       <div className="w-16 h-16 rounded-full bg-zinc-100 dark:bg-zinc-800 text-foreground/70 dark:text-zinc-400 flex items-center justify-center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M13 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V9z"></path><polyline points="13 2 13 9 20 9"></polyline></svg>
                      </div>
                      <div>
                        <p className="text-foreground font-medium">Haz clic aquí para seleccionar o arrastra tu archivo</p>
                        <p className="text-foreground/60 dark:text-zinc-500 text-sm mt-1">PDF, PNG, JPG hasta 5MB</p>
                      </div>
                    </div>
                  )}
                </div>
              ...
              <>
                ...
                <p className="text-foreground/70 dark:text-zinc-400 mb-6">
                  Indícanos cuántos kWh sueles consumir al mes aproximadamente para poder estimar el ahorro.
                </p>

                <div className="space-y-4">
                  <div>
                    <label className="text-sm font-medium text-foreground/80 dark:text-zinc-300 block mb-2">Consumo medio mensual (kWh)</label>
            ...
            <div className="mt-8 flex gap-4">
              <button onClick={handleBack} className="px-6 py-3 rounded-xl border border-zinc-300 dark:border-zinc-700 text-foreground/80 dark:text-zinc-300 font-bold hover:bg-zinc-100 dark:bg-zinc-800 transition-colors">
                Volver
              </button>
              <button 
                onClick={handleNext}
        ...
        {step === 3 && (
          <div className="animate-in fade-in slide-in-from-right-4 duration-500">
            ...
            <p className="text-foreground/70 dark:text-zinc-400 mb-6">
              Selecciona las opciones que mejor describan tu día a día en el hogar. Esto nos ayuda a recomendarte la tarifa horaria perfecta.
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 max-h-[50vh] overflow-y-auto pr-2 custom-scrollbar">
              {HABIT_OPTIONS.map((habit) => (
                ...
                >
                  ...
                  <span className={`font-medium ${formData.habits.includes(habit.id) ? "text-primary-400" : "text-foreground/80 dark:text-zinc-300"}`}>
                    {habit.label}
                  </span>
                </button>
              ))}
        ...
        {step === 4 && (
          <div className="animate-in fade-in slide-in-from-right-4 duration-500">
            ...
            <p className="text-foreground/70 dark:text-zinc-400 mb-6">
              Déjanos tus datos para que podamos enviarte el estudio personalizado y detallado de tu ahorro.
            </p>

            <form onSubmit={submitForm} className="space-y-4">
              <div className="space-y-2">
                <label className="text-sm font-medium text-foreground/80 dark:text-zinc-300">Nombre Completo *</label>
                <input 
                  type="text" 
                  required
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="space-y-2">
                  <label className="text-sm font-medium text-foreground/80 dark:text-zinc-300">Correo Electrónico *</label>
                  <input 
                    type="email" 
                    required
                ...
                <div className="space-y-2">
                  <label className="text-sm font-medium text-foreground/80 dark:text-zinc-300">Teléfono Móvil *</label>
                  <input 
                    type="tel" 
                    required
              ...
              <div className="space-y-2">
                <label className="text-sm font-medium text-foreground/80 dark:text-zinc-300">¿En qué compañía estás ahora? *</label>
                <input 
                  type="text" 
                  required
              ...
              <div className="mt-8 flex gap-4 pt-4 border-t border-zinc-200 dark:border-zinc-800">
                <button type="button" onClick={handleBack} disabled={isSubmitting} className="px-6 py-3 rounded-xl border border-zinc-300 dark:border-zinc-700 text-foreground/80 dark:text-zinc-300 font-bold hover:bg-zinc-100 dark:bg-zinc-800 transition-colors disabled:opacity-50">
                  Volver
                </button>
                <button 
                  type="submit"
        ...
        {step === 5 && (
          <div className="animate-in zoom-in-95 fade-in duration-500 text-center py-8">
            <div className="w-24 h-24 rounded-full bg-green-500/20 flex items-center justify-center mx-auto mb-6">
              <svg className="w-12 h-12 text-green-500" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg>
            </div>
            <h2 className="text-3xl font-heading font-bold text-foreground mb-4">
              ¡Estudio solicitado con éxito!
            </h2>
            <p className="text-lg text-foreground/70 dark:text-zinc-400 max-w-md mx-auto mb-8">
              Hemos recibido tus datos correctamente. Nuestro equipo de expertos energéticos se pondrá a trabajar en tu caso y te contactará muy pronto.
            </p>
            <div className="bg-zinc-50 dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-6 text-left max-w-sm mx-auto mb-8">
              <h3 className="font-bold text-foreground mb-4 border-b border-zinc-200 dark:border-zinc-800 pb-2">Resumen de tu solicitud</h3>
              <ul className="space-y-2 text-sm text-foreground/70 dark:text-zinc-400">
                <li><strong className="text-foreground/80 dark:text-zinc-300">Nombre:</strong> {formData.contact.name}</li>
                <li><strong className="text-foreground/80 dark:text-zinc-300">Email:</strong> {formData.contact.email}</li>
                <li><strong className="text-foreground/80 dark:text-zinc-300">Teléfono:</strong> {formData.contact.phone}</li>
                <li><strong className="text-foreground/80 dark:text-zinc-300">Compañía actual:</strong> {formData.contact.company}</li>
                <li><strong className="text-foreground/80 dark:text-zinc-300">Análisis vía:</strong> {formData.method === 'upload' ? 'Archivo de factura' : `${formData.kwConsumed} kWh manual`}</li>
              </ul>
            </div>
            <button 
